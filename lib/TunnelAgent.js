...
const START_PORT = parseInt(process.env.START_PORT)
const END_PORT = parseInt(process.env.END_PORT)

function getRandomPort(){
    const tgtPort = START_PORT + Math.floor(Math.random() * (END_PORT-START_PORT));
    return tgtPort;
}
